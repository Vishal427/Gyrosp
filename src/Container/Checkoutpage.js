  ...
  <div className="shopping-cart">
    ...
    <div className="product">
      ...
      <div className="product-details">
        ...
        <p className="product-description">
          ...
          for these things! I got curious once and ate one myself. I'm a fan.
        </p>
      </div>
    ...
    <div className="product">
      ...
      <div className="product-details">
        ...
        <p className="product-description">
          Who doesn't like lamb and rice? We've all hit the halal cart at 3am
          while quasi-blackout after a night of binge drinking in Manhattan. Now
          it's your dog's turn!
        </p>
      </div>
